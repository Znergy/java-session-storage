public class ChangeMachine {
  ...
  // public ChangeMachine(Float total) {
  //   mQuarters = makeQuarterChange(total);
  //   mDimes = makeDimeChange(total);
  //   mNickels = makeNickelChange(total);
  //   mPennies = makePennyChange(total);
  // }
  //
  // public void setQuarters(Float total) {
  //   mQuarters = makeQuarterChange(total);
  //   System.out.println("Quarters: " + mQuarters);
  // }
